...
```{r}
# Assuming you have a trained model, for example, the model with ntree = 10
rf_model_ntree_5 <- results[["ntree_5"]]  # Replace with your specific model
...
knn_model <- train(
  ...
  tuneGrid = data.frame(k= c(3, 5, 7)) # grid of k values to tune
)

knn_model # view trained model
```
